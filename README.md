...
- 작업
  ...
  - 트랜잭션 관리자를 활성화하는 애노테이션을 Java Config에 설정한다.
     @EnableTransactionManagement 애노테이션 추가
...
- 작업
  - 매너지관리, 학생관리, 강사관리, 로그인/로그아웃을 각각 한 개의 클래스로 통합한다.
...
- 작업
  ...
  - 이전 서플릿에서 했던 redirect, include를 프론트 컨트롤러에게 넘긴다.
...
- Service 컴포넌트 적용
  ...
  - 고객사마다 업무로직을 달리할 수 있도록 구조를 변경한다.
- 작업
