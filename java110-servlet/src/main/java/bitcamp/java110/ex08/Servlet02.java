...
public class Servlet02 extends HttpServlet {
    ...
    public void doGet(
        ...
        // sendRedirect()를 호출하기 전에 버퍼의 내용을 웹 브라우저로 출력한다면?
        // => sendRedirect()는 무시된다.
        out.flush();
        ...
        // => out.println() 등을 사용하여 출력한 내용은 실제 내부 버퍼에 보관되어 있다.
        //    즉, 아직 출력하지 않은 상태이다.
        // => sendRedirect()를 호출하면, 이 버퍼에 보관된 내용을 버려 버린다.
        // => 응답할 떄도 웹 브라우저에게 message-body를 출력하지 않는다.
        
        // 질문2) 버퍼가 꽉 차면 어떻게 되나요?
        // => 그럼 자동으로 출력한다.
...
// 리프래시 응답 프로토콜
/*
HTTP/1.1 200 <=== 응답 상태 코드는 일반적인 요청처리와 같은 200이다
Content-Type: text/html;charset=UTF-8
Content-Length: 202
Date: Fri, 28 Sep 2018 05:32:53 GMT
...
// 리다이렉트의 응답 프로토콜
/*
Location: http://google.com <=== 웹 브라우저가 다시 요청할 URL정보이다.
Content-Type: text/html;charset=UTF-8
Content-Length: 0
Date: Fri, 28 Sep 2018 05:32:01 GMT
*/