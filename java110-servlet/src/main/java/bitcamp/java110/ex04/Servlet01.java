...
public class Servlet01 extends GenericServlet{
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 테스트 :
        // => http://localhost:8888/ex04/get.html 페이지에서 값을 입력 후 보내기 버튼을 클릭
...
//   => 물론 Base64 인코딩을 이용하여 바이너리 데이터를 텍스트 데이터로 변환한 후에 보낼 수는 있다.
//   => 하지만, 결국 대용량의 데이터인 경우에는 마찬가지로 크기 제한 때문에 불가능하다.
// - 적용 부분
