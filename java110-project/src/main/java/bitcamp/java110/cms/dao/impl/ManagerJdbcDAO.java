...
public class ManagerJdbcDAO implements ManagerDAO {
    ...
    public int insert(Manager manager) {
        ...
        try {
            ...
            // 매니저 정보를 입력할 때 p1_memb 테이블과 p1_mgr 테이블에 매니저 정보를 분산 입력해야한다
            ...
            String sql = " insert into p1_memb(name, email, pwd, tel,cdt ) " + " values('" + manager.getName() + "','"
                    + manager.getEmail() + "', password('" + manager.getPassword() + "'),'" + manager.getTel()
                    + "',now())";

            // p1_memb 테이블에 회원 기본 정보를 입력한 후 자동으로 생성된 회원 번호를 리턴 받는다.
            ...
            String sql2 = "insert into p1_mgr(mrno,posi)" + " values(" + memberNo + ",'" + manager.getPosition() + "')";
