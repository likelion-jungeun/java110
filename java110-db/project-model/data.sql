...
-- 게시물 첨부 파일
insert into p1_att_file(fi_nm,bno) value('file1.txt',1);
insert into p1_att_file(fi_nm,bno) value('file2.txt',1);
insert into p1_att_file(fi_nm,bno) value('file3.txt',2);
insert into p1_att_file(fi_nm,bno) value('file4.txt',3);
insert into p1_att_file(fi_nm,bno) value('file5.txt',3);
insert into p1_att_file(fi_nm,bno) value('file6.txt',5);
insert into p1_att_file(fi_nm,bno) value('file7.txt',8);