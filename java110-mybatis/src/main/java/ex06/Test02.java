...
public class Test02 {
    ...
    public static void main(String[] args) throws Exception{
        ...
        // 게시물 상세조회를할 때 작성자의 정보 또한 자세히 출력하는 상황이라면,
        // => ex05에서와 달리 작성자의 상세정보를 가져오기 위해  p1_memb테이블에 대해 따로 select를 하지 않는다.
        // => 게시물을 가져올 때 join해서 작성자 정보까지 가져온다.
        // => 단, 게시물에 작성자 정보도 담아야 하기 때문에
        //    Board테이블에 email과 tel필드를 추가해야 한다.
        // => 목록에서 간단히 name을 추가하는 경우와 달리
        //    Board 클래스에 작성자의 대부분의 정보를 저장할 필드를 추가해야 한다.
        // => 이것은 객체지향의 중요한 특징 중 하나인 
        //    "High Cohesion"(높은 응집력; 한 클래스 한 역할)을 어기는 것이다.
        //    한 클래스가 여러 역할을 맡으면 유지보수가 어려워진다.
        // => 즉, p1_memb 테이블에 변경이 발생하면 Member 클래스 외에 Board클래스도 영향을 받는 것이 문제이다.
        // => 해결책 : ex07을 보라!
